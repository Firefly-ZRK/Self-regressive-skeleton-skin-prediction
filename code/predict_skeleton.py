...
def predict(args):
    """
    Main prediction function for skeleton joints
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Predict skeleton joints from point cloud')
    ...
    parser.add_argument('--model_type', type=str, default='standard',
                        choices=['standard', 'enhanced', 'autoregressive'],
    ...
    parser.add_argument('--num_joints', type=int, default=22,
                        help='Number of joints for autoregressive model')
